...
DesStatePublisher::DesStatePublisher(ros::NodeHandle& nh) : nh_(nh) {
    ...
    current_pose_ = trajBuilder_.xyPsi2PoseStamped(0.001,-0.052,0.005);
...
bool DesStatePublisher::appendPathQueueCB(my_mobot::pathRequest& request, my_mobot::pathResponse& response) {
